// 2025.03.18 Kan-Sky for South Korea CT6_2019
...
//Kan-Sky 2025.03.18    // int gas_regen = ((GET_BYTE(to_send, 1) & 0x1U) << 13) + ((GET_BYTE(to_send, 2) & 0xFFU) << 5) + ((GET_BYTE(to_send, 3) & 0xF8U) >> 3);
    int gas_regen = ((GET_BYTE(to_send, 2) & 0x7FU) << 5) + ((GET_BYTE(to_send, 3) & 0xF8U) >> 3); //  + ((GET_BYTE(to_send, 3) & 0xF8U) >> 3);
